...
const CardKeranjang = ({ pesan }) => {
  return (
    <View style={styles.container}>
      <Image source={pesan.produk.gambar} style={styles.gambar} />
      ...
      <View style={styles.desc}>
        ...
        <Text style={styles.textBold}>Pesan : {pesan.jumlahPesanan}</Text>
        <Text style={styles.textBold}>
          Total Harga: Rp. {numberWithCommas(pesan.subTotal)}
        </Text>
        <Text style={styles.textBold}>Keterangan:</Text>
        <Text style={styles.textBold}>{pesan.keterangan} </Text>
      </View>
